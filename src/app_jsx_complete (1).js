                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <p className={`font-bold ${
                          ...
                          {transaction.sender_id === user.id ? '-' : '+'}{formatNumber(transaction.amount)} {transaction.token_type}
                        </p>
                        <p className={`text-xs ${
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                This app uses enterprise-grade security: email verification, rate limiting, 
                input sanitization, database-level constraints, row-level security, and real-time updates.
              </p>
            </div>
          </div>
        </div>
